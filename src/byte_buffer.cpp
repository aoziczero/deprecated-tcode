...
tcode::byte_buffer byte_buffer::sub_buffer( const std::size_t start , const std::size_t len ){
	return tcode::byte_buffer( rd_ptr() + start , len );
}

tcode::byte_buffer byte_buffer::duplicate(void){
	return tcode::byte_buffer(*this);
}

tcode::byte_buffer byte_buffer::copy(void){
	return tcode::byte_buffer( block::copy( _block ) , _pos );
}
